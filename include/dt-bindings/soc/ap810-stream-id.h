...
#define MVEBU_STREAM_ID_CP0_XOR0			(MVEBU_STREAM_ID_BASE + MVEBU_STREAM_ID_CP_XOR0_OFFSET)

#define MVEBU_STREAM_ID_CPx_XORx(cp_num, xor_num)	(MVEBU_STREAM_ID_CP0_XOR0 + \

...
#define PSP_TIMER_JITTER_CORRECT_MASK (~PSP_TIMER_ADD_VALUE_MASK)
#define PDB_GRP_THR_MASK GENMASK_ULL(63, 56)
#define PDB_PKT_MAX_MASK GENMASK_ULL(53, 48)
...
enum otx2_cpt_dl_param_id {
	...
	CN20K_CPT_DEVLINK_PARAM_ID_PSP_TIMER_JITTER_CORRECT,

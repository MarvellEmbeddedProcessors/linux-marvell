...
static inline int sdhci_runtime_suspend_host(struct sdhci_host *host) { return 0; }
static inline int sdhci_runtime_resume_host(struct sdhci_host *host, int soft_reset) { return 0; }
#endif

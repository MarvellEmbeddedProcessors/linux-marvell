...
int npc_cn20k_debugfs_init(struct rvu *rvu)
{
	...
	debugfs_create_file("vidx2idx", 0444, rvu->rvu_dbg.npc, npc_priv,
			    &npc_vidx2idx_map_fops);
	debugfs_create_file("idx2vidx", 0444, rvu->rvu_dbg.npc, npc_priv,
			    &npc_idx2vidx_map_fops);

	debugfs_create_file("defrag", 0444, rvu->rvu_dbg.npc, npc_priv,
			    &npc_defrag_fops);
